...
- Blender koordinatı OLDUĞU GİBİ; origin taşıma yok, başlangıç = entrance_node_id.
- id'ler benzersiz string; ShelfBlock.id catalog.json shelf'inden türetilir.
"""
...
class Edge(BaseModel):
    """Yönsüz koridor kenarı. weight = metre cinsinden yürüme maliyeti."""
    from_id: str
    to_id: str
...
class Placement(BaseModel):
    """Ürün yerleşimi. product_id, catalog.json'daki int id ile birebir aynı."""
    product_id: int
    shelf_block_id: str
